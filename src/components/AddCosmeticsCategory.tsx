...
const AddCosmeticsCategory = ({ onClose }: { onClose: () => void }) => {
  const [name, setName] = useState("");
  const [status, setStatus] = useState("active");
  const { mutate, isPending } = useAddCosmeticCategory(); // اصلاح نام به isLoading
...
export default AddCosmeticsCategory;
